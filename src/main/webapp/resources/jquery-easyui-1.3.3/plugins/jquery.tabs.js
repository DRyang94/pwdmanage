...
(function ($) {
        ...
        if (_9 > _a) {
            ...
            if (_3.toolPosition == "left") {
                ...
                _8.css({
                    ...
                    width: _a - _6.outerWidth() - _7.outerWidth()
                });
            } else {
    ...
    function _2b(_2c, pp, _2d) {
        ...
        pp.panel($.extend({}, _2d, {
            ...
            closed: true,
            doSize: false,
            iconCls: (_2d.icon ? _2d.icon : undefined),
            onLoad: function () {
                if (_2d.onLoad) {
    ...
    $.fn.tabs = function (_66, _67) {
        ...
        return this.each(function () {
            ...
            if (_68) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _66),
                    tabs: [],
                    selectHis: []
                });
                _20(this);
    ...
    $.fn.tabs.parseOptions = function (_76) {
        return $.extend({}, $.parser.parseOptions(_76, ["width", "height", "tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number"
