...
(function ($) {
    ...
    $.fn.validatebox.parseOptions = function (_23) {
        var t = $(_23);
        return $.extend({}, $.parser.parseOptions(_23, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            deltaX: "number"
